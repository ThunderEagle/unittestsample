...
namespace ConferenceRegistration.Moq.Tests
{
	...
	public class RegistrationServiceTestsWithUnity
	{
		...
		public void FixtureSetup()
		{
			...
			_container.RegisterInstance<IFeeCalculator>(feeCalculator.Object);
		}
		...
		public void Setup()
		{
			...
			_container.RegisterInstance<IPaymentProcessor>(_paymentProcessor.Object);
		}
		...
		public void RegisterForConference_PaymentProcessingSucceeds_EntitySaved()
		{
			...
			_container.RegisterInstance<IEmailSender>(new Mock<IEmailSender>().Object);
			...
			_container.RegisterInstance<IRegistrationRepository>(repository.Object);
		...
		public void RegisterForConference_PaymentProcessingFails_ThrowsException()
		{
			...
			_container.RegisterInstance<IRegistrationRepository>(new Mock<IRegistrationRepository>().Object);
